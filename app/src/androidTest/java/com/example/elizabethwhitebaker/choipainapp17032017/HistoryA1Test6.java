...
public class HistoryA1Test6 {
    ...
    public void testUserInputScenerio()
    {
        ...
        Espresso.onView(withId(R.id.editText6)).perform(typeText(email3));
        Espresso.onView(withId(R.id.editText5)).perform(typeText(ethinicity));
